		...
		<div id="content">
			<div class="post">
				...
				<div class="entry" id="a">
					<form action="finance/test.php" method="post" class="smart-green">
		...
		<div id="sidebar">
			<ul>
				...
				<li>
					<h2>Categories</h2>
					<ul>
						<li><a href="#a">Customize Profile</a></li>
						<li><a href="#b">View Profile</a></li>
						<li><a href="#c">View Budget List</a></li>
						<li><a href="#d">Create New Budget</a></li>
