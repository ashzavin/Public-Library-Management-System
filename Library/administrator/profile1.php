...
<body>
	<div id="header">
		<div id="logo">
			...
			<h1><a href="#">Administrative Officer Profile</a></h1>
	...
	<div id="page-bgbtm">
		<div id="content">
			<div class="post">
				...
				<div class="entry">
					<form action="administrator/test.php" method="post" class="smart-green">
						...
						<label>
							...
							<input id="" type="email" name="email" placeholder="Your Full Name" />
						</label>
						
						<label>
							<span>Your Phone :</span>
							<input id="email" type="text" name="phn1" placeholder="Valid Email Address" />
						</label>
						
						<label>
							<span>Your Salary :</span>
							<input id="email" type="text" name="salary" placeholder="Valid Email Address" />
						</label>
						<label>
							<span>Your Joining_date:</span>
							<input id="" type="text" name="join_date" placeholder="Phone no 1" />
							
						</label>
						
						<label>
							<span>Your Post :</span>
							<input id="" type="text" name="post" placeholder="Valid Email Address" />
						</label>
			...
			$id=$_SESSION['id'];
			//echo $id;
			$array = oci_parse($c, "select * from employee where emp_id='$id' ");
		...
		echo '<div class="post">
				<h2 class="title"><a href="#">All Employee Lists</a></h2>';
				
				 $array3 = oci_parse($c, "select * from employee");
								...
								while(($row3 = oci_fetch_array($array3, OCI_BOTH)) != false) {
									...
									echo '<div id="entry">
										<table style="border: 1px solid black;">
										  ...
										  <tr style="border: 1px solid black;">';
							            echo'<td style="border: 1px solid black;">'.$emp_id.'</td>';
										echo'<td style="border: 1px solid black;">'.$emp_name.'</td>';
										echo'<td style="border: 1px solid black;">'.$salary.'</td>';
										echo'<td style="border: 1px solid black;">'.$join.'</td>';
										echo'<td style="border: 1px solid black;">'.$post.'</td>';
										echo'<td style="border: 1px solid black;">'.$email.'</td>';
										echo'<td style="border: 1px solid black;">'.$address.'</td>';
										$array2 = oci_parse($c, "select phone from emp_phone where emp_id='$emp_id' ");
		...
		?>
			...
			<div class="post">
				<h2 class="title"><a href="#">Create New Employee Account</a></h2>
				
				
				
				<form action="administrator/test2_finance.php" method="post" class="smart-green">
						
						<label>
							<span>Employee Naame:</span>
							<input id="name" type="text" name="name" placeholder="year" />
						</label>
						
						<label>
							<span>Salary:</span>
							<input id="" type="text" name="salary" placeholder="" />
						</label>
						
						<label>
							<span>Joining Date:</span>
							<input id="email" type="text" name="join" placeholder="" />
						</label>
						...
						<label>
							<span>Address:</span>
							<input id="" type="text" name="address" placeholder="" />
							
						</label>
						
						<label>
							<span>Phone :</span>
							<input id="" type="text" name="phn1" placeholder="" />
						</label>
						
						<label>
							<span>Office Number:</span>
							<input id="" type="text" name="office" placeholder="" />
							
						</label>
						
						<label>
							<span>Project Section :</span>
							<input id="" type="text" name="project" placeholder="" />
						</label>
						
						<label>
							<span>Branch Number:</span>
							<input id="" type="text" name="branch" placeholder="" />
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li><a href="#">Create New Employee Account</a></li>
