					...
					<div class="content">
						<div class="services">
							...
							<?php
								...
								$array = oci_parse($c, "select title,price,subject,t_book,image,a_name,p_name from book_list natural join written_by natural join author natural join published_by natural join publisher where upper(title) like 
								'$titlee1' or lower(title) like '$titlee1' or initcap(title)='$titlee1' and upper(a_name)='$authorr1' or lower(a_name)='$authorr1' or initcap(a_name)='$authorr1' and subject='$subjectt' ");
